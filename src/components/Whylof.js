          ...
          <MDBRow className="pt-md-5 d-flex justify-content-start justify-content-md-center align-items-center">
              ...
              <MDBRow>
                <div className="d-flex ">
                  <MDBCol
                    ...
                    lg={2}
                    sm={2}
                    className="lof-feature py-3 ms-2"
                  >
                  ...
                  <MDBCol
                    ...
                    lg={6}
                    sm={6}
                    className="lof-feature pt-3 my-auto"
                  >
                    <p>More Profit</p>
                  </MDBCol>
                </div>
                ...
                <MDBCol md={12} sm={12} lg={12} className="feature-txt ms-2">
                  <p>
                    You will keep up to 95% of all your sales! In addition to
                    that, you can release your content as NFT's, and get a share
                    of the price every single time the NFT is resold - forever.
                  </p>
                </MDBCol>
              </MDBRow>
            </MDBCol>
            <MDBCol md={6} lg={6} sm={12} className="mb-md-5 feature-bg1">
              <MDBRow>
                ...
                <MDBCol md={12} sm={12} lg={12} className="feature-txt ms-2">
                  <p>
                    We looked at other fan platforms and what they were missing.
                    We worked with content creators and asked what could be done
                    better. Turns out there were plenty, and our platform has
                    been built to fix that.
                  </p>
                </MDBCol>
              </MDBRow>
            </MDBCol>
            <MDBCol md={6} lg={6} sm={12} className="feature-bg">
              <MDBRow>
                ...
                <MDBCol md={12} sm={12} lg={12} className="feature-txt ms-2">
                  <p>
                    We are aware of the problems the other fan platforms have
                    had. On LOF, your payments will always be in time without
                    any extra hassle.
                  </p>
                </MDBCol>
              </MDBRow>
              ...
              <MDBRow>
                ...
                <MDBCol md={12} sm={12} lg={12} className="feature-txt ms-2">
                  <p>
                    ...
                    obeys the law. Your content can be just as mild or just as
                    kinky as you want. There will be no surprise account
                    closings or changes in terms of use. We are on your side,
