...
Cryptocurrency is a digital representation of value that functions as a medium of exchange, a unit of account, or a store of value, but it does not have legal tender status. Cryptocurrencies are sometimes exchanged for FIAT currencies around the world, but they are not generally backed or supported by any government or central bank. Their value is completely derived by market forces of supply and demand, and they are more volatile than traditional currencies. The value of cryptocurrency may be derived from the continued willingness of market participants to exchange fiat currency for cryptocurrency, which may result in the potential for permanent and total loss of value of a particular cryptocurrency should the market for that cryptocurrency disappear. </p>
          ...
          <MDBCol sm={12} className='text-light py-4'>
            <h3 className='PinkColor fweight'>Regulatory Landscape</h3>
...
<br/>Purchasing cryptocurrencies comes with a number of risks, including volatile market price swings or flash crashes, market manipulation, and cybersecurity risks. In addition, cryptocurrency markets and exchanges are not regulated with the same controls or customer protections available in equity, option, futures, or foreign exchange investing. There is no assurance that a person who accepts a cryptocurrency as payment today will continue to do so in the future.
<br/>Investors should conduct extensive research into the legitimacy of each individual cryptocurrency, including its platform, before investing. The features, functions, characteristics, operation, use and other properties of the specific cryptocurrency may be complex, technical, or difficult to understand or evaluate. <br/>
The cryptocurrency may be vulnerable to attacks on the security, integrity or operation, including attacks using computing power sufficient to overwhelm the normal operation of the cryptocurrency’s blockchain or other underlying technology. Some cryptocurrency transactions will be deemed to be made when recorded on a public ledger, which is not necessarily the date or time that a transaction may have been initiated.<br/>Cryptocurrency trading requires knowledge of cryptocurrency markets. In attempting to profit through cryptocurrency trading you must compete with traders worldwide. You should have appropriate knowledge and experience before engaging in substantial cryptocurrency trading.
<br/>
Any individual cryptocurrency may change or otherwise cease to operate as expected due to changes made to its underlying technology, changes made using its underlying technology, or changes resulting from an attack. These changes may include, without limitation, a "fork," a "rollback," an "airdrop," or a "bootstrap." Such changes may dilute the value of an existing cryptocurrency position and/or distribute the value of an existing cryptocurrency position to another cryptocurrency.
          ...
          <MDBCol sm={12} className='text-light py-4'>
            ...
            <br/>Our mission is to become a layer of trust for digital financial systems at internet scale, and the highest level of security is a mandatory prerequisite.

<br/>The security researcher community regularly makes valuable contributions to the security of organizations and the broader Internet, and Lonelyfans recognizes that fostering a close relationship with the community will help improve the security of the Lonelyfans ecosystem. So, if you have information about a vulnerability in the Lonelyfans ecosystem and associated components, we want to hear from you.
</p>
          </MDBCol>
...
<br/>Future Lonelyfans applications may require Users to download and install updates to the application or to their device’s operating system as such updates are made available. Failure to do so might lead to certain parts of the Services (including trading functions) becoming inaccessible to Members until such update has been successfully downloaded and installed. Performance issues and security risks may arise if Lonelyfans mobile applications are used on devices with customized or otherwise non-standard operating software or as a result of other software installed on such devices.
    ...
    The Platform may utilize public communication network circuits for the transmission of messages. Lonelyfans shall not be liable for any and all circumstances in which you experience a delay in price quotation or an inability to trade caused by network transmission problems or restrictions or any other problems outside our direct control, which include but are not limited to the strength of the mobile signal, network latency, or any other issues that may arise between you and any internet service provider, phone service provider or any other service provider. Please note further that some of the features available on the Trading Platform may not be available on any mobile application.
    <br/>
    Future Lonelyfans applications may require Users to download and install updates to the application or to their device’s operating system as such updates are made available. Failure to do so might lead to certain parts of the Services (including trading functions) becoming inaccessible to Members until such update has been successfully downloaded and installed. Performance issues and security risks may arise if Lonelyfans mobile applications are used on devices with customized or otherwise non-standard operating software or as a result of other software installed on such devices.</p>
        </MDBCol>
...
What to include:</p>
      ...
      <ul>
        ...
        <li>An open dialog to discuss issues.</li>
        ...
        <MDBCol sm={12} className='text-light py-4'>
            ...
            <br/>Please do:</p>
            <ul>
              <li>Allow the Lonelyfans team a reasonable amount of time address security vulnerabilities</li>
              <li>Avoid exploiting any vulnerabilities that you discover</li>
              <li>Demonstrate good faith by not disrupting or degrading Lonelyfans services, products & data</li>
            </ul>
            <p>Lonelyfans pledges not to initiate legal action against researchers as long as they adhere to this policy.</p>
...
<br/>3.	We update the token technology right away
</p>
            </MDBCol>
            ...
            <MDBCol sm={12} className='text-light py-4 pb-5'>
...
<br/>
In order to protect the Lonelyfans ecosystem, we request that you not post or share any information about a potential vulnerability in any public setting until we have researched, responded to, and addressed the reported vulnerability and informed partners if needed.
</p>
            </MDBCol>
        </MDBRow>
